...
- Fabric built-in Power BI Copilot answering users' questions on the reports.
...
Note: The Fabric Data Agent is available across all architecture options.
