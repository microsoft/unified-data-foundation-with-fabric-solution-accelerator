...
This solution accelerator builds a [medallion lakehouse architecture](https://learn.microsoft.com/en-us/fabric/onelake/onelake-medallion-lakehouse-architecture) in the Microsoft Fabric platform, provides a custom-built Fabric Data Agent, highlights the capabilities of Copilot for Power BI, and provides options to add integration with Azure Databricks and provision Microsoft Purview for Data Governance.
...
The built-in Copilot for Power BI and Fabric Data Agent utilize Generative AI within Microsoft Fabric. AI is not explicitly used in the solution components.
