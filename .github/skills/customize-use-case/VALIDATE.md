# Validate `customize-use-case` for `unified-data-foundation-with-fabric` (publish surface: `azd-native`)
...
```bash
python .github/skills/customize-use-case/validate.py --check compile --check schema_integrity
```
...
```bash
python .github/skills/customize-use-case/validate.py 2> validate-results.jsonl
```
...
```bash
python .github/skills/customize-use-case/validate.py --self-test
```
...
repos:
  - repo: local
    hooks:
      - id: sa-validate-customize-use-case
        name: validate customize-use-case
        entry: python .github/skills/customize-use-case/validate.py
        language: system
