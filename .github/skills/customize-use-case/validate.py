#!/usr/bin/env python3
"""
validate.py — Architecture-aware validator for customize-use-case.
...
To run a single check by name:
    ...
    python .github/skills/customize-use-case/validate.py --check environment
...
#   --------------------------------  ------  --------------------------------
#   customize-use-case                    token   generation argument (kebab-case skill id)
...
SKILL_NAME: str = "customize-use-case"
